...
ballId = p.loadSoftBody("artery1000.obj", simFileName = "artery1000.vtk", basePosition = [0,0,-1], scale = 0.001, mass = 4, useNeoHookean = 1, NeoHookeanMu = 400, NeoHookeanLambda = 600, NeoHookeanDamping = 0.001, useSelfCollision = 1, frictionCoeff = .5, collisionMargin = 0.001)
p.setTimeStep(0.001)
