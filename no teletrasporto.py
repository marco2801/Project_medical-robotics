...
vessel2=p.loadSoftBody("Arteria_piena.obj", simFileName="Arteria_piena.vtk", basePosition=[-vessel_outer_radius, 2*vessel_length+0.025, 0], baseOrientation=p.getQuaternionFromEuler([ np.pi/2,0, 0]),
